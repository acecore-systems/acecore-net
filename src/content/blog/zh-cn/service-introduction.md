...
callout:
  type: info
  title: 权威信息来源
  text: 各项业务的服务范围、价格、参与方式和最新信息，均以相应专业网站的更新为准。
checklist:
  title: 按目的选择网站
  items:
    - text: Acecore：组织信息、方针和跨业务咨询
...
faq:
  title: 常见问题
  items:
    - question: 系统开发或网站制作应该在哪里咨询？
      answer: 请查看 Acecore Systems 的服务介绍并使用其联系渠道。
...
有关 IT 支持、系统与网站开发、设计、运维支持、价格、案例和技术解说，请查看 [Acecore Systems](https://systems.acecore.net/zh-cn/)。
