...
description: 'Informationen über Acecore und die offiziellen Anlaufstellen von Systems, Schools, Aceserver und Acecore Shop.'
...
checklist:
  ...
  items:
    ...
    - text: Acecore Shop – offizieller Onlineshop: Produkte, Kauf, Versand und Rückgaben
faq:
  ...
  items:
    ...
    - question: Wo finde ich Informationen zu Produkten, Kauf und Versand des Onlineshops?
      answer: Aktuelle Informationen zu Produkten, Kauf, Versand und Rückgaben finden Sie bei Acecore Shop.
---
...
Aktuelle Informationen zu Produkten, Kauf, Versand und Rückgaben finden Sie bei [Acecore Shop](https://shop.acecore.net/).

## Kontakt zu Acecore

Informationen zur Organisation finden Sie unter [Über uns](/de/about/). Für bereichsübergreifende Anfragen und Kooperationen nutzen Sie bitte [Kontakt](/de/contact/).
