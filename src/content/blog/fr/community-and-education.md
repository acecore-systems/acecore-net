...
insightGrid:
  ...
  items:
    - title: Aceserver
      description: Gestion d'un serveur Minecraft comme point de départ pour les échanges communautaires.
...
## Aceserver : une communauté qui grandit à partir du jeu

**Aceserver**, géré par Acecore, est un serveur Minecraft public utilisé par de nombreux joueurs. Au-delà d'un simple espace d'échanges ludiques, il sert également de plateforme pour la validation technique de la gestion de serveurs et la pratique de la gestion de communauté.
...
![Les échanges dans la communauté Aceserver sont ouverts à tous, sans distinction d'âge ni d'expérience](/uploads/acecore-generated/education-programming-class.webp)
...
![Des apprenants suivant un programme basé sur la pratique professionnelle](/uploads/acecore-generated/education-programming-class.webp)

## Contribution à l'open source

Chez Acecore, nous attachons de l'importance non seulement à bénéficier des logiciels open source, mais aussi à y contribuer activement. Une partie des outils et bibliothèques développés en interne sont publiés sur [GitHub](https://github.com/acecore-systems), permettant de redonner à la communauté technique.
