...
Les définitions de tags sont consolidées dans `src/content/tags/{tagId}.json`, chaque tag ayant un champ `i18n.name`. Cela déplace la source de vérité pour les traductions de tags des fichiers JSON de traduction vers la collection de tags.
...
Les cartes d'articles, la barre latérale, l'index des tags et le détail des articles référencent tous la collection de tags pour changer les noms affichés, garantissant que tous les tags s'affichent de manière unifiée dans la langue appropriée.
