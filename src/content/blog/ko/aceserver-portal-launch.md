...
Aceserver는 Java Edition과 Bedrock Edition 모두에서 플레이할 수 있는 공개 서버입니다. 이번 포털에서는 서버 개요, 참여 안내, 영상, 월드 맵, Wiki 동선을 하나의 입구로 정리했습니다. Acecore의 [실적 페이지](/ko/works/#case-aceserver-portal)에도 웹 제작 및 커뮤니티 포털 사례로 등록했습니다.
...
가벼운 CMS 운영에 대한 생각은 [Sveltia CMS와 Cloudflare Turnstile로 만드는 가벼운 CMS 운영](/ko/blog/cms-selection-and-turnstile/)에서도 소개합니다. 정적 사이트의 표시 속도와 운영은 [Astro 사이트 표시 속도 개선 실전 가이드](/ko/blog/astro-performance-tuning/)를 참고할 수 있습니다.

## 실적으로도 추가했습니다

Acecore의 [실적 및 포트폴리오 페이지](/ko/works/)에는 “Aceserver 포털 제작”으로 사례를 추가했습니다.

기존 [Aceserver 공개 서버 운영](/ko/works/#case-aceserver) 사례는 공개 서버 자체의 안정 운영과 커뮤니티 운영을 다룹니다. 이번 사례는 플레이어가 정보를 찾고 참여하기 위한 포털 제작에 초점을 둡니다.
