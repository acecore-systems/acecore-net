...
callout:
  type: info
  title: 공개 사이트
  text: 'Hatt 홈페이지는 https://hatt.acecore.net/ 에서 공개 중입니다. 그림, 소설, VRChat용 3D 아바타와 기믹 제작을 하나의 입구로 모았습니다.'
processFigure:
  title: 제작 과정에서 정리한 동선
  steps:
    - title: 활동 정리
      description: 그림, 소설, 모델링의 세 축으로 분류했습니다.
      icon: i-lucide-layout-grid
    - title: CMS화
      description: 블로그와 작품 정보를 Sveltia CMS로 업데이트할 수 있게 했습니다.
      icon: i-lucide-file-pen-line
    - title: 검색 도입
      description: Pagefind로 글과 작품을 더 쉽게 찾을 수 있게 했습니다.
      icon: i-lucide-search
    - title: 외부 연동
      description: YouTube, X, BOOTH로 이어지는 동선을 정리했습니다.
      icon: i-lucide-external-link
insightGrid:
  title: Hatt 사이트의 주요 구성
  items:
    - title: 그림
      description: 캐릭터와 세계관 메모를 글과 작품으로 남길 수 있는 동선을 마련했습니다.
      icon: i-lucide-palette
      tone: brand
    - title: 소설
      description: 외부 투고 사이트에 공개한 이야기로 가는 입구와 창작 기록을 모았습니다.
      icon: i-lucide-book-open
      tone: amber
    - title: 모델링
      description: VRChat용 아바타, 기믹, 액세서리 제작을 BOOTH와 YouTube에 연결했습니다.
      icon: i-lucide-box
      tone: emerald
linkCards:
  - href: https://hatt.acecore.net/
    title: Hatt 홈페이지
    description: 공개 중인 Hatt 공식 사이트입니다.
    icon: i-lucide-external-link
  - href: /ko/works/#case-hatt-homepage
    title: Hatt 홈페이지 제작 사례
    description: Acecore 실적 페이지에도 제작 사례로 게재했습니다.
    icon: i-lucide-briefcase-business
  - href: /ko/services/#web
    title: 웹사이트 제작 및 운영
    description: 개인 사이트, 포트폴리오, 비즈니스 사이트 제작 상담 안내입니다.
    icon: i-lucide-globe
faq:
  title: 자주 묻는 질문
  items:
    - question: Hatt 홈페이지에서는 무엇을 볼 수 있나요?
      answer: 그림, 소설, VRChat용 3D 아바타와 기믹 제작, 프로필, 외부 활동 링크를 한곳에 모았습니다.
...
이 사이트는 그림, 소설, VRChat용 3D 아바타와 기믹 제작을 하나의 입구로 정리한 홈페이지입니다. Acecore의 [실적 페이지](/ko/works/#case-hatt-homepage)에도 웹 제작 및 CMS 구축 사례로 게재했습니다.
...
Astro 사이트에서 SEO와 OGP를 정리하는 방식은 [Astro 사이트에 구조화 데이터와 OGP를 구현하는 SEO 개선 가이드](/ko/blog/astro-seo-and-structured-data/)에서도 소개하고 있습니다.
...
Acecore의 [실적 및 포트폴리오](/ko/works/)에는 “Hatt 홈페이지 제작”으로 사례를 추가했습니다.
...
웹사이트 제작 상담은 [웹사이트 제작 및 운영 서비스](/ko/services/#web) 또는 [문의하기](/ko/contact/)에서 가능합니다.

## 정리

Hatt 홈페이지는 그림, 소설, VRChat용 3D 아바타와 기믹 제작을 모은 창작 활동의 입구로 공개했습니다.

Acecore는 개인 사이트, 포트폴리오 사이트, 비즈니스 사이트 등 목적에 맞춘 웹사이트를 제작합니다. 활동 내용 정리부터 CMS, 검색, SEO, 공개 후 운영까지 함께 상담하고 싶다면 [웹사이트 제작 및 운영 서비스](/ko/services/#web) 또는 [문의하기](/ko/contact/)에서 연락해 주세요.
