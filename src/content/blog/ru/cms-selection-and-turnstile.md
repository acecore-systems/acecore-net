...
Заголовки безопасности и настройки Cloudflare Pages для статических сайтов подробно рассмотрены в статье [Безопасная доставка статического сайта с помощью Cloudflare Pages](/blog/cloudflare-pages-security/).
