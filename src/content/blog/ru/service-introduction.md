...
Acecore — корпоративный сайт, объединяющий информацию о компании и ссылки на каждое из её направлений. Чтобы не дублировать специализированные описания и обновления, подробная информация по каждой области собрана на следующих официальных сайтах.
...
Информацию о компании можно найти на странице [О нас](/ru/about/), а для обращений по нескольким направлениям и предложений о сотрудничестве — на странице [Контакты](/ru/contact/).
