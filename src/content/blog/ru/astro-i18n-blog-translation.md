...
Автоматизация Copilot для непрерывного ведения процесса перевода собрана в [конвейере перевода блога с GitHub Copilot](/blog/copilot-translation-pipeline/).
