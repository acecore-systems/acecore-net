...
Информацию о затратах на создание веб-сайта и объёме операций также можно найти в [Руководстве по стоимости создания сайтов и ключевым моментам в сметах](/blog/homepage-production-cost-guide/).
