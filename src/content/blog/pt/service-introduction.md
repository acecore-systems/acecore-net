...
A Acecore é o site corporativo que reúne informações sobre a empresa e serve como porta de entrada para cada uma de suas atividades. Para evitar a duplicação de explicações especializadas e atualizações, as informações detalhadas de cada área estão concentradas nos seguintes sites oficiais.
...
Formas de aprendizagem, apoio educacional, métodos de consulta e registros de atividades estão disponíveis na [Acecore Schools](https://schools.acecore.net/).
...
Produtos e informações mais recentes sobre compras, entrega e devoluções estão disponíveis na [Acecore Store](https://store.acecore.net/).

## Entre em contato com a Acecore

Para informações sobre a empresa, consulte [Sobre nós](/pt/about/). Para consultas que envolvam várias atividades ou propostas de colaboração, consulte [Contato](/pt/contact/).
