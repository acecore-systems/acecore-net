...
A automação com Copilot para manter continuamente a operação de tradução está resumida em [Pipeline de tradução de blog com GitHub Copilot](/blog/copilot-translation-pipeline/).
